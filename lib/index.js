...
export function apply(ctx, config) {
  ...
  const tools = [
    defineTool({
      ...
      parameters: {
        type: 'object',
        properties: { task: { type: 'string', description: 'The task to investigate or implement' } },
        required: ['task'],
      },
    ...
    defineTool({
      ...
      parameters: {
        type: 'object',
        properties: {
          kind: { type: 'string', description: 'implementation or investigation' },
          summary: { type: 'string', description: 'What the workstream found or built' },
